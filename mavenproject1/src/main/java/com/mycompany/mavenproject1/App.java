...
public class App extends Application {
    ...
    public void start(Stage primaryStage) { 
        ...
        Group grp = new Group();
        Scene scene = new Scene(grp, 1000, 1000, Color.WHITE);
        ...
        fieldHbox1.getChildren().addAll(field1, field2, field3, field4, field5, field6, field7, field8, field9, field10);
        ...
        HBox hbox3 = new HBox();
        Label dLabel = new Label("Selection Sort Description:   Selection sort is a sorting algorithm that treats the input as two parts, a sorted part and an unsorted part, and repeatedly selects the proper next value to move from the unsorted part to the end of the sorted part.");
        hbox3.getChildren().add(dLabel);
        VBox vbox1 = new VBox();
        vbox1.setSpacing(100);
        vbox1.getChildren().addAll(hbox3, fieldHbox1, buttonHbox, sLabel, sSlabel);
        ...
        HBox Hbox2 = new HBox();
        Hbox2.getChildren().addAll(field1a, field2a, field3a, field4a, field5a, field6a, field7a, field8a, field9a, field10a);
        ...
        buttonHbox2.getChildren().addAll(randBtna, startBtna, resetBtna);
        
        Tab tab4 = new Tab();
        tab4.setText("Insertion Sort");
        HBox hbox4 = new HBox();
        hbox4.getChildren().add
        (new Label("Insertion Sort Description:   Insertion Sort splits an array into 2 parts, a sorted and unsorted part, and then repeatedly takes a value from the unsorted part and inserts it into the correct location of the sorted part."));
        VBox vbox2 = new VBox();
        vbox2.setSpacing(100);
        vbox2.getChildren().addAll(hbox4, Hbox2, buttonHbox2, iVLabel, sILabel);
        ...
        fieldHbox3.getChildren().addAll(field1b, field2b, field3b, field4b, field5b, field6b, field7b, field8b, field9b, field10b);
        ...
        buttonHbox3.getChildren().addAll(randBtnb, startBtnb, resetBtnb);
        ...
        (new Label("Merge Sort Description:   Merge Sort divides an input into 2 halves, sorts each half, and then merges them back together and does this for each half that the algorithm will recursively create."));
        VBox vbox3 = new VBox();
        vbox3.setSpacing(100);
        vbox3.getChildren().addAll(hbox5, fieldHbox3, buttonHbox3, mVLabel, sMLabel);
        ...
        (new Label("Quick Sort Description:    Quick Sort divides the input into high and low parts using a pivot (the pivot is usually the middle value) and then sorts the high and low parts."));
        VBox vbox4 = new VBox();
        vbox4.setSpacing(100);
        vbox4.getChildren().addAll(hbox6, fieldHbox4, buttonHbox4, qVLabel, sQLabel);
